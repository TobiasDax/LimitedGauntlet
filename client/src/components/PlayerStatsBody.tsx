...
import { CardGallery, formatEur } from "./CardGallery";
import { Card } from "./ui";
import type { HeadToHeadEntry, PlayerStatsDetail } from "../lib/types";

// Shared between the authed PlayerStatsPage and the public
// /o/:slug/hall-of-fame/players/:id page — identical content either way.
