...
export function GesamtwertungPage() {
  ...
  return (
    <div>
      ...
      {gesamtwertung.length === 0 ? (
        <p className="text-ink-muted">No players attending yet.</p>
      ) : (
        <div className="flex flex-col gap-0.5">
          {(() => {
            ...
            return gesamtwertung.map((row, i) => {
              ...
              return (
                ...
                >
                  <div className={`grid h-[34px] w-[34px] place-items-center rounded border font-display text-[15px] font-bold ${rankBadgeClasses(rank)}`}>
                    {rank}
                  </div>
                  ...
                  <div className="text-right">
                    <div className={`font-display tabular-nums text-[26px] leading-none font-bold ${rank === 1 ? "text-accent-strong" : ""}`}>
